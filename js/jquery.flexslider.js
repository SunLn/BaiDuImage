  ...
  $.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      if (slider.vars.directionNav) {
        var directionNavScaffold = $('<ul class="flex-direction-nav"><li><a class="prev" href="#" hidefocus="hidefocus">' + slider.vars.prevText + '</a></li><li><a class="next" href="#" hidefocus="hidefocus">' + slider.vars.nextText + '</a></li></ul>');
